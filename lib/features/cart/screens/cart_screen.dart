...
class _CartScreenState extends State<CartScreen> {
  ...
  void initState() {
    ...
    context.read<CartCubit>().getUserName();
    super.initState();
  }
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            var key = context
                                ...
                                .elementAt(index);
                            ProductModel? product =
                                context.read<CartCubit>().cart1?[key];
                            return CartListItem(
                              product: product,
                            );
                          },
                ...
                state is EmptyCartState
                    ...
                    : Container(
                        ...
                        child: CustomButton(
                            ...
                            text: "confirm".tr(),
                            onPressed: () async {
                              String? sessionIdTrueUser = await Preferences
                                  .instance
                                  .getSessionIdTrueUser();
                              if (cubit.cart1!.isNotEmpty &&
                                  sessionIdTrueUser != null) {
                                await cubit.createSaleOrder();
                                int? orderId =
                                    await Preferences.instance.getSaleOrder();
                                ...
                                Navigator.pushNamed(
                                    context, Routes.redirectToSignInRoute);
                                // ScaffoldMessenger.of(context).showSnackBar(
                                //     SnackBar(
